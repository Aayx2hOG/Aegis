...
2. Add focused tests for alert evaluation, notification delivery idempotency, research fallback, and war-room risk math.
3. Clean up package-manager and README consistency.
4. Decide whether the Anchor watchlist is a core feature or optional infrastructure, then adjust the UI/docs accordingly.
