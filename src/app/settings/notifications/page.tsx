      ...
      <section className="grid gap-4 lg:grid-cols-3">
        ...
        >
          ...
          <p className="mt-2 text-xs leading-relaxed text-zinc-400 font-medium font-mono">
            &gt; Keep notification routing here as a utility setting, separate from primary navigation like Research,
            War Room, and Watchlist.
          </p>
        </SpotlightCard>
        <SpotlightCard
          spotlightColor="rgba(6, 182, 212, 0.03)"
        ...
        >
          ...
          <p className="mt-2 text-sm font-orbitron font-bold text-white uppercase tracking-wider">
            Wallet-linked alert delivery
          </p>
          <p className="mt-2 text-xs text-zinc-400 leading-relaxed font-mono">
            Manage channels tied to your current wallet identity.
          </p>
        </SpotlightCard>
      </section>
