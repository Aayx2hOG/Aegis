        ...
        <div className="mx-auto max-w-6xl space-y-8 py-6">
            <header className="space-y-4">
                ...
                <div className="space-y-2">
                    <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.08)]">
                        Stress Test Your Cross-Chain Portfolio
                    </h1>
                    ...
                    <div className="rounded-md bg-yellow-900/10 border border-yellow-850 p-3 text-xs text-yellow-200/90 mt-2">
                        {UI_DISCLAIMER}
                    </div>
                </div>
            </header>
                ...
                <div className="space-y-8 animate-in fade-in duration-500">
                    <section className="space-y-4">
                        <h2 className="text-xs font-bold uppercase tracking-[0.16em] text-zinc-400">How It Works</h2>
                        <div className="grid gap-4 md:grid-cols-3">
                            <SpotlightCard spotlightColor="rgba(255, 255, 255, 0.02)" borderColor="rgba(255, 255, 255, 0.1)" className="border-zinc-800 bg-zinc-950/40 p-5">
                                <p className="text-[10px] font-bold uppercase tracking-widest text-zinc-500">Step 1</p>
                                <p className="mt-2 text-sm font-bold text-white">Manage multi-chain portfolio</p>
                                <p className="mt-1.5 text-xs text-zinc-400 leading-relaxed font-medium">Configure assets across Solana, Ethereum, Base, and other networks.</p>
                            </SpotlightCard>
                            <SpotlightCard spotlightColor="rgba(255, 255, 255, 0.02)" borderColor="rgba(255, 255, 255, 0.1)" className="border-zinc-800 bg-zinc-950/40 p-5">
                                <p className="text-[10px] font-bold uppercase tracking-widest text-zinc-500">Step 2</p>
                                <p className="mt-2 text-sm font-bold text-white">Run systemic scenarios</p>
                                <p className="mt-1.5 text-xs text-zinc-400 leading-relaxed font-medium">Simulate bridge downtime, L2 sequencer outages, or global panic shocks.</p>
                            </SpotlightCard>
                            <SpotlightCard spotlightColor="rgba(255, 255, 255, 0.02)" borderColor="rgba(255, 255, 255, 0.1)" className="border-zinc-800 bg-zinc-950/40 p-5">
                                <p className="text-[10px] font-bold uppercase tracking-widest text-zinc-500">Step 3</p>
                                <p className="mt-2 text-sm font-bold text-white">Hedge and route arbitrage</p>
                                <p className="mt-1.5 text-xs text-zinc-400 leading-relaxed font-medium">Apply cross-chain rebalancing steps and capture price spreads.</p>
                            </SpotlightCard>
                        </div>
                    </section>

                    <section className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                        <div className="lg:col-span-3 rounded-2xl bg-zinc-950/40 border border-zinc-800 p-5 backdrop-blur-md space-y-4">
                            ...
                            <div className="rounded-xl border border-zinc-800 bg-zinc-950/20 p-4 space-y-3">
                                <h3 className="text-xs font-bold uppercase tracking-wider text-zinc-400">Add Custom Holding</h3>
                                <div className="grid gap-3 grid-cols-2 sm:grid-cols-5">
                                    <div>
                                        ...
                                        <select
                                            ...
                                            className="flex h-9 w-full rounded-md border border-zinc-800 bg-zinc-950 px-3 py-1 text-xs shadow-xs transition-colors focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-ring focus:border-zinc-700 focus:ring-1 focus:ring-zinc-800 disabled:cursor-not-allowed disabled:opacity-50 text-white"
                                        >
                        ...
                        <div className="lg:col-span-2 rounded-2xl bg-zinc-950/40 border border-zinc-800 p-5 backdrop-blur-md space-y-4">
                            <div className="flex justify-between items-center">
                                <h2 className="font-bold text-lg">Choose Cross-Chain Scenario</h2>
                                <button
                                    type="button"
                                    onClick={() => setSimpleMode(!simpleMode)}
                                    className={`rounded-lg px-3 py-1 text-[10px] font-bold uppercase tracking-wider border transition-all duration-200 ${simpleMode
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-full rounded-lg px-3 py-3 text-left transition border ${idx === selectedMultichainScenarioIdx
                                                ...
                                                : 'bg-zinc-950/30 border-zinc-800/60 text-zinc-400 hover:bg-zinc-900/50 hover:text-zinc-200'
                                                }`}
                                        >
                            ...
                            <Button
                                ...
                                className="w-full h-11 bg-white hover:bg-zinc-200 text-zinc-950 font-bold uppercase tracking-wider text-xs shadow-[0_0_12px_rgba(255,255,255,0.08)] hover:shadow-[0_0_18px_rgba(255,255,255,0.18)] transition-all cursor-pointer rounded-lg"
                            >
                    ...
                    {multichainResult && (
                        <section className="space-y-6 animate-in fade-in duration-500">
                                                ...
                                                <div className="space-y-2.5">
                                                    <div className="space-y-1">
                                                        ...
                                                        <div className="h-1 rounded-full bg-zinc-900 overflow-hidden">
                                                            <div className="h-full bg-zinc-400" style={{ width: `${cr.marketRisk}%` }} />
                                                        </div>
                                                    </div>
                                                    <div className="space-y-1">
                                                        <div className="flex items-center justify-between text-[10px] text-zinc-400">
                                                        ...
                                                        <div className="h-1 rounded-full bg-zinc-900 overflow-hidden">
                                                            <div className="h-full bg-zinc-400" style={{ width: `${cr.liquidityRisk}%` }} />
                                                        </div>
                                                    </div>
                                                    <div className="space-y-1">
                                                        <div className="flex items-center justify-between text-[10px] text-zinc-400">
                                                        ...
                                                        <div className="h-1 rounded-full bg-zinc-900 overflow-hidden">
                                                            <div className="h-full bg-zinc-400" style={{ width: `${cr.concentrationRisk}%` }} />
                                                        </div>
                                                    </div>
                                                    <div className="space-y-1">
                                                        <div className="flex items-center justify-between text-[10px] text-zinc-400">
                                                        ...
                                                        <div className="h-1 rounded-full bg-zinc-900 overflow-hidden">
                                                            <div className="h-full bg-zinc-400" style={{ width: `${cr.liquidationRisk}%` }} />
                                                        </div>
                                                    </div>
                                                    <div className="space-y-1">
                                                        <div className="flex items-center justify-between text-[10px] text-zinc-400">
                                                        ...
                                                        <div className="h-1 rounded-full bg-zinc-900 overflow-hidden">
                                                            <div className="h-full bg-zinc-400" style={{ width: `${cr.smartContractRisk}%` }} />
                                                        </div>
                                                    </div>
                                                    {cr.bridgeRisk !== undefined && cr.bridgeRisk > 0 && (
                                                        <div className="space-y-1">
                                                            ...
                                                            <div className="h-1 rounded-full bg-zinc-900 overflow-hidden">
                                                                <div className="h-full bg-rose-500/80" style={{ width: `${cr.bridgeRisk}%` }} />
                                                            </div>
                                                        </div>
                                                    )}
                                                </div>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                                <div className="lg:col-span-3 rounded-2xl bg-zinc-950/40 border border-zinc-800 p-5 space-y-4">
                                    ...
                                    {multichainResult.rebalancingRecommendations.length === 0 ? (
                                        ...
                                        <div className="space-y-3">
                                            {multichainResult.rebalancingRecommendations.map((rec, idx) => (
                                                <div key={idx} className="rounded-xl p-4 bg-zinc-900/20 border border-zinc-800/60 space-y-2">
                                                    <div className="flex flex-wrap items-center justify-between gap-2">
                                                        <div className="flex items-center gap-2">
                                                            <span className={`rounded-full px-2.5 py-0.5 text-[9px] font-bold uppercase ${rec.action === 'move' ? 'bg-emerald-500/20 text-emerald-300 border border-emerald-500/30' : rec.action === 'liquidate' ? 'bg-rose-500/20 text-rose-300 border border-rose-500/30' : 'bg-zinc-800/40 text-zinc-300 border border-zinc-700/30'}`}>
                                                                {rec.action}
                                                            </span>
                                                            <p className="font-bold text-sm text-zinc-100">{rec.assetSymbol} • {rec.protocol}</p>
                                                        </div>
                                ...
                                <div className="lg:col-span-2 rounded-2xl bg-zinc-950/40 border border-zinc-800 p-5 space-y-4">
                                            ...
                                            {multichainResult.crossChainArbitrageOpportunities.map((opp, idx) => (
                                                <div key={idx} className="rounded-xl p-4 bg-zinc-900/20 border border-zinc-800/60 space-y-2">
                                                    <div className="flex items-center justify-between">
                                                        <p className="font-bold text-sm text-zinc-100">{opp.assetSymbol} Arbitrage</p>
...
function MetricCard({
    ...
    return (
        <SpotlightCard
            ...
            className="border-zinc-800 bg-zinc-950/40 p-5"
        >
            <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-500">{label}</p>
            <p className={`text-2xl font-extrabold mt-3 ${accent ?? 'text-white'}`}>{value}</p>
            <p className="mt-2 text-xs text-zinc-400 font-medium leading-relaxed">{helper}</p>
        </SpotlightCard>
    )
}
