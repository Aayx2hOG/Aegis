    ...
    try {
      ...
      if (UPSTASH_URL && UPSTASH_TOKEN) {
        try {
          ...
          console.error('[optional-explanation-webhook] failed to enqueue notification message', err)
        }
      } else {
        ...
        try {
          ...
          console.error('[optional-explanation-webhook] fallback notification delivery failed', err)
        }
      }
    } catch (err) {
