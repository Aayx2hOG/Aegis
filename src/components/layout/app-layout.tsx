  ...
  return (
    <ThemeProvider attribute="class" defaultTheme="system" enableSystem disableTransitionOnChange>
      <div className="relative flex min-h-screen flex-col overflow-x-hidden bg-background text-zinc-100 selection:bg-cyan-300 selection:text-zinc-950">
        <div className="app-atmosphere pointer-events-none fixed inset-0 bg-[linear-gradient(90deg,rgba(6,182,212,0.045),transparent_22%,transparent_78%,rgba(16,185,129,0.035)),linear-gradient(180deg,rgba(255,255,255,0.035),transparent_32%)]" />
        <MarketBackdrop />
