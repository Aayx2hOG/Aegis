  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-2 z-10">
        {icon && <div className="text-zinc-400 transition-transform group-hover/bento:scale-110 duration-300 w-fit">{icon}</div>}
        {title && (
        ...
        {description && (
          <div className="text-zinc-400 text-xs leading-relaxed font-normal">
            {description}
          </div>
        )}
      </div>
